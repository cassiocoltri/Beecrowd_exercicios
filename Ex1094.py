...
precisa de sua ajuda para organizar
...
sapo, rato, coelho, totalCobaias = 0, 0, 0, 0
...
per_sapo = sapo * 100.0 / totalCobaias
per_rato = rato * 100.0 / totalCobaias
per_coelho = coelho * 100.0 / totalCobaias
