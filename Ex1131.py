...
e pelo Grêmio em um GRENAL. Logo após escrever a mensagem "Novo grenal (1-sim 2-nao)" e solicitar uma resposta.
...
jogos, vInter, vGremio, empates = 0, 0, 0, 0
while True:
